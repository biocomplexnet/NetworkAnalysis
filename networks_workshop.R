...
# setwd("c:/docs/mydir") 
# Linux:
# setwd("/home/sol/mydir") 
# Mac:
# setwd("/Users/sol/mydir") 
...
#===========================================================================
download.file(
  url = "https://raw.githubusercontent.com/biocomplexnet/NetworkAnalysis/main/data/coexp_h_5.tsv",
  destfile = "data/coexp_h_5.tsv"
  )
download.file(
  url = "https://raw.githubusercontent.com/biocomplexnet/NetworkAnalysis/main/data/coexp_t_5.tsv",
  destfile = "data/coexp_t_5.tsv"
  )
download.file(
  url = "https://raw.githubusercontent.com/biocomplexnet/NetworkAnalysis/main/data/treatment_1.tsv",
  destfile = "data/treatment_1.tsv"
  )
download.file(
  url = "https://raw.githubusercontent.com/biocomplexnet/NetworkAnalysis/main/data/treatment_2.tsv",
...
#===========================================================================
net <- graph_from_data_frame(B1, directed = FALSE)
View(net)
